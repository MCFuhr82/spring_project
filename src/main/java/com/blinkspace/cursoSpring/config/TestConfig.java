...
import com.blinkspace.cursoSpring.entities.*;
import com.blinkspace.cursoSpring.entities.enums.OrderStatus;
import com.blinkspace.cursoSpring.repositories.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Payment pay1 = new Payment(null, Instant.parse("2022-11-15T17:23:25Z"), o1);
        o1.setPayment(pay1);
