...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2022-11-15T15:23:25Z"), u1);
        Order o2 = new Order(null, Instant.parse("2022-11-20T15:23:25Z"), u2);
        Order o3 = new Order(null, Instant.parse("2022-11-25T15:23:25Z"), u1);
